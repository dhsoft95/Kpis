    ...
    <x-filament::section>
                    ...
                    <div class="w-full md:w-1/3 mt-4 md:mt-0 md:ml-4">
                        <ul>
                            ...
                            <span class="flex items-center">
                                <img src="https://cdn.jsdelivr.net/npm/flag-icons@1.0.0/flags/4x3/{{ $country['code'] }}.svg" class="w-6 h-4 mr-2" alt="">
                                {{ $country['name'] }}
                            </span>
            ...
            @push('scripts')
                ...
                <script type="text/javascript">
                    import google
                        from "../../../vendor/phpunit/php-code-coverage/src/Report/Html/Renderer/Template/js/nv.d3.min.js";
